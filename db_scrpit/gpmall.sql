...
-- ----------------------------
-- Table structure for tb_item_stat
-- ----------------------------
DROP TABLE IF EXISTS `tb_item_stat`;
CREATE TABLE `tb_item_stat` (
  `item_id` bigint(20) NOT NULL COMMENT '商品ID',
  `pv` bigint(255) DEFAULT '0' COMMENT '浏览量',
  `sales` bigint(255) DEFAULT '0' COMMENT '销售量',
  `score` float(255,0) DEFAULT '0' COMMENT '平均分',
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of tb_item_stat
-- ----------------------------
INSERT INTO `tb_item_stat` VALUES ('100023501', '26986', '20932', '3');
INSERT INTO `tb_item_stat` VALUES ('100026701', '263138', '251578', '3');
INSERT INTO `tb_item_stat` VALUES ('100026801', '515993', '277065', '4');
INSERT INTO `tb_item_stat` VALUES ('100036501', '211962', '128079', '4');
INSERT INTO `tb_item_stat` VALUES ('100039702', '609601', '584666', '4');
INSERT INTO `tb_item_stat` VALUES ('100040501', '367843', '127569', '3');
INSERT INTO `tb_item_stat` VALUES ('100040607', '259375', '257119', '4');
INSERT INTO `tb_item_stat` VALUES ('100042203', '289967', '97474', '2');
INSERT INTO `tb_item_stat` VALUES ('100042801', '610473', '308123', '3');
INSERT INTO `tb_item_stat` VALUES ('100046401', '81175', '62757', '4');
INSERT INTO `tb_item_stat` VALUES ('100047001', '293357', '196568', '1');
INSERT INTO `tb_item_stat` VALUES ('100047101', '70435', '65016', '4');
INSERT INTO `tb_item_stat` VALUES ('100051701', '860429', '174561', '2');
INSERT INTO `tb_item_stat` VALUES ('100052801', '539842', '181038', '2');
INSERT INTO `tb_item_stat` VALUES ('100053001', '52728', '40016', '4');
INSERT INTO `tb_item_stat` VALUES ('100053202', '617321', '245026', '5');
INSERT INTO `tb_item_stat` VALUES ('100053312', '699874', '375363', '3');
INSERT INTO `tb_item_stat` VALUES ('100055301', '723374', '465947', '3');
INSERT INTO `tb_item_stat` VALUES ('100055601', '203148', '47703', '4');
INSERT INTO `tb_item_stat` VALUES ('100057401', '777288', '678423', '5');
INSERT INTO `tb_item_stat` VALUES ('100057501', '544108', '49579', '4');
INSERT INTO `tb_item_stat` VALUES ('100057601', '708318', '362177', '2');
INSERT INTO `tb_item_stat` VALUES ('100057701', '437577', '399207', '4');
...
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='用户表';
...
INSERT INTO `tb_member` VALUES ('66', 'mic', '4eea1e5de59fbc61cb3ab480dbbf6a5f', null, null, '2019-08-06 00:15:48', '2019-08-06 00:15:48', null, null, '1', 'https://gper.club/server-img/avatars/000/00/00/user_origin_30.jpg?time1565591384242', null, null, null, 'Y');
INSERT INTO `tb_member` VALUES ('81', 'admin', 'e10adc3949ba59abbe56e057f20f883e', null, '412771478@qq.com', '2019-11-25 08:33:31', '2019-11-25 08:33:31', null, null, '1', null, null, null, null, 'Y');
...
CREATE TABLE `tb_order` (
  ...
  `unique_key` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '唯一键',
...
-- ----------------------------
INSERT INTO `tb_user_verify` VALUES ('15', 'admin', '2019-11-25 08:33:32', '5a5c36a15b255c67b1acf4b5d8d1a5eb', 'Y', 'N');
