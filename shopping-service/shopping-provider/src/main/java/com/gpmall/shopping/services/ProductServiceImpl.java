...
import com.gpmall.shopping.dal.persistence.*;
...
public class ProductServiceImpl implements IProductService {
    ...
    @Autowired
    ItemStatisticMapper itemStatisticMapper;
...
/*
    ...
    @Override
    public ItemStatResponse getItemStatById(long id) {
        ItemStatistic itemStat = itemStatisticMapper.selectByPrimaryKey(id);
        return productConverter.itemStat2Response(itemStat);
    }
